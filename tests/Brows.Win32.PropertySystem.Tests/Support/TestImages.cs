...
/// to produce real files. JPEG is used (rather than, e.g., plain text) because the
/// built-in Windows Photo property handler reliably supports both reading and writing
/// metadata properties (Title, Keywords, etc.), which plain text files do not.
/// </summary>
internal static class TestImages {
    private const string TinyJpegBase64 =
        ...
        "/2wBDAQMEBAUEBQkFBQkUDQsNFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBT/wAARCAAEAAQDASIAAhEBAxEB/8" +
        ...
        "l6goOEhYaHiImKkpOUlZaXmJmaoqOkpaanqKmqsrO0tba3uLm6wsPExcbHyMnK0tPU1dbX2Nna4uPk5ebn6Onq8vP09fb3+Pn6/9oADAMBAAIRAxEAPwD8q" +
        "qKKKAP/2Q==";

    public static byte[] TinyJpegBytes
        => Convert.FromBase64String(TinyJpegBase64);
}
